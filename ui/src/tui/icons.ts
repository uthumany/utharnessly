export type IconName = 'selector' | 'blinker' | 'chat' | 'task' | 'running' | 'waiting' | 'failed' | 'warning' | 'success' | 'file' | 'folder' | 'agent' | 'skill' | 'memory' | 'job' | 'model' | 'tool' | 'logs' | 'settings' | 'git' | 'shell' | 'search' | 'context' | 'edit' | 'test' | 'build' | 'lock' | 'computer' | 'improve' | 'fix';
const unicode: Record<IconName, string> = { selector: '𓆃', blinker: '𓇩', chat: '◇', task: '✓', running: '◆', waiting: '○', failed: '✗', warning: '!', success: '✓', file: '▤', folder: '▣', agent: '𓄆', skill: '✦', memory: '𓏞', job: '◷', model: '◇', tool: '⚙', logs: '≡', settings: '⚙', git: '⑂', shell: '>', search: '⌕', context: '▥', edit: '✎', test: '𓄣', build: '𓉐', lock: '◈', computer: '𓂀', improve: '𓋹', fix: '𓌙' };
const ascii: Record<IconName, string> = { selector: '>', blinker: '*', chat: '[*]', task: '[+]', running: '[*]', waiting: '[-]', failed: '[x]', warning: '[!]', success: '[+]', file: '[file]', folder: '[dir]', agent: '[agent]', skill: '[skill]', memory: '[scroll]', job: '[job]', model: '[model]', tool: '[tool]', logs: '[log]', settings: '[cfg]', git: '[git]', shell: '[>]', search: '[?]', context: '[ctx]', edit: '[edit]', test: '[test]', build: '[build]', lock: '[lock]', computer: '[eye]', improve: '[ankh]', fix: '[fix]' };
