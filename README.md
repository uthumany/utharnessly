...
A native Termux package is built under [`packages/utharness`](./packages/utharness) and is published through the signed UTHARNESS APT repository. The current release line provides v0.2.11 packages and does not require root:
