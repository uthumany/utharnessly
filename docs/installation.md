...
| Termux | **Supported package path; device validation pending** | Use the signed v0.2.36 repository. Real terminal behavior, Android-version compatibility, and Termux:API execution still require device testing. |
