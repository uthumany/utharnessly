...
**QA target:** source line 0.2.7; published baseline v0.2.6 at the beginning of this iteration
...
The v0.2.6 Termux repository remains live and was cryptographically verified from its public Pages endpoints. Physical Android devices/emulators, iOS/iPadOS local terminals, FreeBSD, ARM desktop variants, and every named terminal emulator were not available for direct execution and are not marked as passed.
...
| PASS-018 | Hosted CI | Pass | [CI run 33091416438][1] |
| PASS-019 | Hosted Security | Pass | [Security run 33091416441][2] |
| PASS-020 | Published Termux repository | Pass | v0.2.6 Pages scripts, key identity, InRelease/Release.gpg signatures, package indexes, packages, and SHA-256 manifest verified |
...
The highest remaining product risk is the absence of direct Android-device validation. The next release must publish the coordinated 0.2.7 source/package versions, then reinstall from the live Termux repository on at least one real `aarch64` device or emulator. Registry NPM/PyPI versions also need publication and live-install verification for 0.2.7. No API key or signing private key is included in this report.

[1]: https://github.com/uthumany/utharnessly/actions/runs/33091416438 "Hosted CI run"
[2]: https://github.com/uthumany/utharnessly/actions/runs/33091416441 "Hosted Security run"
